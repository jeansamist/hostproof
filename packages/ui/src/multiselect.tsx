      ...
      >
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            return (
              <div
                key={option.value}
                className={cn(
                  "animate-fadeIn bg-accent text-accent-foreground hover:bg-accent relative inline-flex h-7 cursor-default items-center rounded-md border ps-2 pe-7 pl-2 text-xs font-medium transition-all disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2",
                  badgeClassName,
                )}
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "placeholder:text-muted-foreground/70 flex-1 outline-hidden disabled:cursor-not-allowed",
              {
